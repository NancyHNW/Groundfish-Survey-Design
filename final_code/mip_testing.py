...
# prob_id = 35
# filename = glob.glob(f"my_code/better_test_problems/test_problem{prob_id:02d}*")[0]
...
for node_compress in [True]:
    ...
    for prob_id in probs:
        ...
        perc_list = [10] #100, 75, 50, 25, 10, 5, 1]
        # perc_list = [50]
        # if prob_id == 15:
        #     perc_list = [1]
        for perc_to_keep in perc_list:
            ...
            # with open('my_code/output_mip_vars.txt', 'a') as f:
            #     f.write(str(result) + '\n')
